...
cam_transform_path = '/home/marklee/IAM/xArm/camera-calibration/data/cam_transform.csv'
end_effector_transform_path = '/home/marklee/IAM/xArm/camera-calibration/data/ee_transform.csv'
...
def transformation_publisher():
    ...
    print("size of effector2world: ", len(effector2world[0]))
